...
def train():
    ...
    # MODEL_DIR = os.environ["D:\ML Internship\dockerfile\my-model"]
    # MODEL_FILE_LDA = os.environ["clf_lda.joblib"]
    # MODEL_FILE_NN = os.environ["clf_nn.joblib"]
    # MODEL_PATH_LDA = os.path.join(MODEL_DIR, MODEL_FILE_LDA)
    # MODEL_PATH_NN = os.path.join(MODEL_DIR, MODEL_FILE_NN)
      
    # Load, read and normalize training data
    training = "D:\ML Internship\my-model\train.csv"
